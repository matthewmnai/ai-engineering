...
PROCESSED_DATA_DIR = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "../outputs/step4_finetune/processed_data")
...
def run_finetune(model_name=None, data_path=None, output_dir=None,
    ...
    print(f"\n--- 5/6 开始SFT训练 ---")
    stats = train_sft(model, tokenizer, dataset, os.path.join(output_dir, "train"), max_steps, use_gpu)
    ...
    print(f"  LoRA模型已保存: {save_model_dir}")
    ...
    eval_dir = os.path.join(output_dir, "processed_data")
